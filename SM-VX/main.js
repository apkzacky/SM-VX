...
function showSelectedOperator() {
    ...
    for (var i = 0; i < elements.length; i++) {
        elements[i].style.backgroundColor = "#444343";
    }

    if (operator_value == "+") {
        document.getElementById("plusOp").style.backgroundColor = "#84a35a";
    }
    else if (operator_value == "-") {
        document.getElementById("subOp").style.backgroundColor = "#84a35a";
    }
    else if (operator_value == "*") {
        document.getElementById("multiOp").style.backgroundColor = "#84a35a";
    }
    else if (operator_value == "/") {
        document.getElementById("divOp").style.backgroundColor = "#84a35a";
    }
}
...
// saving last Operation to ChromeStorage
function saveHistory() {
    if (total != undefined) {
        localStorage.setItem('LastOperation', `${last_operation_history.innerText}`)
        localStorage.setItem('LastOperationResult', `${total}`)
    }
}

// reseting history data
function clearHistory() {
    localStorage.clear()
}

// fetching last Operation to ChromeStorage
function fetchHistory() {
    button_number()
    box.innerText = localStorage.getItem('LastOperationResult')
    last_operation_history.innerHTML = localStorage.getItem('LastOperation')
